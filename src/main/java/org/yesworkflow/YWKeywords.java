...
public class YWKeywords {
    ...
    public enum Tag { AS, BEGIN, CALL, DESC, END, FILE, IN, LOG, OUT, PARAM, RETURN, URI, LOC, DATA;}
    ...
    public static final String STANDARD_LOC_KEYWORD             = "@loc";
    public static final String STANDARD_DATA_KEYWORD             ="@data";
    ...
    public YWKeywords() {
        ...
        setStandardKeyword(    STANDARD_LOC_KEYWORD,    Tag.LOC     );
        setStandardKeyword(    STANDARD_DATA_KEYWORD,   Tag.DATA    );
    }
